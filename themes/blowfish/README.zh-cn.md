...
📑 [主题文档](https://blowfish.page/zh-cn/blogs/)  
...
## 文档
Blowfish 有 [全面的文档](https://blowfish.page/zh-cn/blogs/)，覆盖主题的任何一个方面。 请确保 [阅读文档](https://blowfish.page/zh-cn/blogs/) 以详细了解本主题有哪些功能。
...
每种方法的详细说明都可以在 [安装](https://blowfish.page/zh-cn/blogs/installation) 文档中找到。为了获得最简单的安装体验，请查阅文档。如果你使用的是 git，请阅读下面使用子模块的快速开始指南；如果你能安装 Hugo 主题，请阅读下面 Hugo 模块的快速开始指南。
...
4. 按照[入门指南](https://blowfish.page/zh-cn/blogs/getting-started/)来配置你的网站
...
5. 按照[入门指南](https://blowfish.page/zh-cn/blogs/getting-started/)来配置你的网站

### Installing theme updates

当新的主题版本发布，你可以在你网站的根目录使用 Hugo 命令`hugo mod get -u`来简单地把主题更新到最新版本。

详细的[更新指南](https://blowfish.page/zh-cn/blogs/installation/#%E6%9B%B4%E6%96%B0%E4%B8%BB%E9%A2%98)在文档中。
